        ...
        return (
                <div class="nav-bar-container">
                        ...
                        <ul class="nav-bar-list">
                            ...
                            <li onClick={changePathState}> <Link class={`nav-link nav-link-hover ${pathState === "/cart" ? 'nav-link-chosen' : ''}`} to="/cart"><i class="fa fa-shopping-cart" style={{fontSize:'32px', color: "red"}}></i>  <span class='cart-item-number'>{props.cartInfoState}</span></Link></li>         
                            <li>
